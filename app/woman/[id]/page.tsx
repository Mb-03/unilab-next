...
const Details = () => {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-[90px] py-6 flex gap-15">
      <div>
      ...
      <div className="flex flex-col mt-[96px] font-[latoRegular] flex-1 text-[#262626]">
        ...
        <div className="bg-[#E9E9E9] py-3 px-6 mt-8">
            <span className="font-[latoBold] border-b border-[#C4C4C4] flex pb-2">$79.98</span>
            <span className="pt-2 flex gap-[5px] text-[12px] items-center"><FaPlus  className="bg-[#C4C4C4] rounded-lg p-1 text-white" size={20}/>Add shipping insurance for $9( declared value  only if the package gets lost, stolen or damaged.)</span>
        </div>
        <div className="flex gap-5 mt-8 justify-between">
            <button className="uppercase bg-[#4172DC] text-white px-8 py-4 rounded-sm min-w-[275px]">Shop Now</button>
            <button className="flex items-center uppercase px-8 py-4 text-black border border-[#434343] rounded-sm gap-2 min-w-[275px] justify-center"><img src="/addToCard.svg" alt="add to cart icon" />Add to Basket</button>
        </div>
      </div>
    </div>
  );
